...
class User_sweph_services extends MY_Controller {
    ...
    public $TOLERANCIA_DMO = 0.3333333333333333;
    ...
    public $TIME_LAPSED = 1; //segundos
    public $HOURS_ACCEPTED_CYCLE = 3;
    ...
    public function calculateCorrectUserHour($user_born_event, $list_events) {
        ...
        while ($this->HOURS_COMPLETE != $this->HOURS_ACCEPTED_CYCLE) {
            ...
            if ($array_differences_accepted_by_hour_increment != null || sizeof($array_differences_accepted_by_hour_increment) != 0) {
            ...
            echo"<br>-------->" . json_encode($complete_init_born_date);
            echo"<br>-------->" . json_encode($complete_increment_date);
            echo"<br>-------->" . json_encode($array_differences_accepted_by_hour_increment);
            echo"<br>-------->" . $this->HOURS_COMPLETE;
        }
            ...
            foreach ($lista_planetas_evento as $planeta_evento) {
                ...
                if ($IS_TOLERANCE_DMO_ACCEPTED === 1) {
                    ...
                    $listado_actiscios = $this->calculate_antiscios($ASCENSION_OBLICUA_TRANSCURRIDA, $ascension_oblicua_evento);
                     ...
                     echo "<br>----listado_actiscios------>".  json_encode($listado_actiscios);
    ...
    public function calculate_antiscios($AOT, $AO) {
